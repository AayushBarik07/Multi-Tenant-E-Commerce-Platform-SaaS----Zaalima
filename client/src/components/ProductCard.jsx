  ...
  return (
    <div className="group flex flex-col bg-white rounded-2xl overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 border border-gray-100/50">
      ...
      <div className="relative aspect-[4/5] bg-[#F8F9FA] overflow-hidden p-6 flex items-center justify-center">
        ...
        {/* Wishlist Button */}
        <button className="absolute top-4 right-4 z-10 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-sm text-gray-400 hover:text-[#FF5A24] transition-colors">
        ...
        <div className="flex items-end justify-between mt-auto pt-2">
          <div>
            <div className="flex items-center space-x-1 mb-1">
              ...
              <span className="text-[10px] text-gray-400 font-medium">({Math.floor(Math.random() * 200) + 12})</span>
            </div>
