  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-10 border border-gray-100">
        <div className="h-32 bg-[#FF5A24]"></div>
            ...
            <div className="text-center py-20 bg-gradient-to-br from-gray-50 to-indigo-50 rounded-3xl border border-indigo-100 shadow-sm relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="mx-auto h-16 w-16 bg-indigo-100 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg className="h-8 w-8 text-[#FF5A24]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Link to="/" className="inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-bold rounded-full text-white bg-[#FF5A24] hover:bg-orange-600 shadow-[0_0_15px_rgba(79,70,229,0.4)] hover:scale-105 transition-all">
                  Go back to Home
                </Link>
              </div>
            </div>
              ...
              {brands.map((brand) => (
                ...
                >
                  ...
                  <div className="p-5 text-center">
                    ...
                    <span className="inline-block mt-4 text-sm font-bold text-[#FF5A24] group-hover:text-indigo-800">
        ...
        <>
          <div className="flex items-center mb-6">
            <button 
              ...
              className="mr-4 text-gray-500 hover:text-[#FF5A24] flex items-center text-sm font-medium transition-colors"
            >
